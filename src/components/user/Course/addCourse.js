                            ...
                            <div className="contentpanel">
                                <div className="col-sm-6 col-sm-offset-2">
                                    <form onSubmit={this.handleSubmit} className="form-horizontal form-bordered" method="post">
                                        ...
                                        {/*<div className="form-group">*/}
                                            {/*<select value={this.state.sub_category} onChange={this.handleSubCat} className="form-control" name="category" data-toggle="tooltip" data-trigger="hover"*/}
                                                    {/*className="form-control tooltips" title="Select Course Sub Category">*/}
                                                {/*<option defaultValue='' disabled>Select Sub-Category</option>*/}
                                                {/*{*/}
                                                    {/*this.state.subCategoryData.map((item, index) =>(*/}
                                                        {/*<option key={index} value={item._id}>{item.sub_category}</option>*/}
                                                    {/*))*/}
                                                {/*}*/}
                                            {/*</select>*/}
