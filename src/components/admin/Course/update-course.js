                                ...
                                <div className="col-sm-6 col-sm-offset-2">
                                    <form onSubmit={this.handleSubmit} className="form-horizontal form-bordered" method="post">
                                        ...
                                        <div className="form-group">
                                            <select ref = {(input)=> this.menu = input} value={this.state.category} onChange={this.handleCat} className="form-control" name="category" data-toggle="tooltip" data-trigger="hover"
                                                    className="form-control tooltips" title="Select Course Category">
                                                <option>Select Category</option>
                                                {
                                                    this.state.categoryData.map((item, index) =>(
                                                        <option selected={item.category==this.state.category_id?item.category:''} key={index} value={item._id}>{item.category}</option>
